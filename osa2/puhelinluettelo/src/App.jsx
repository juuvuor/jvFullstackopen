...
const App = () => {
  ...
  const [operationEMessage, setOperationEMessage] = useState(null);
    ...
    if (persons.findIndex(isInTheList) > -1) {
      ...
      personService
        ...
        .then((response) => {
          ...
          setNewName("");
          setNewNumber("");
          setOperationMessage(`Added ${newName} `);
          setTimeout(() => {
            setOperationMessage(null);
          }, 2000);
        })
        .catch((error) => {
          setOperationEMessage(error.response.data.error);
          setTimeout(() => {
            setOperationEMessage(null);
          }, 2000);
  ...
  return (
    <div>
      ...
      <ErrorNotifications message={operationEMessage} />
